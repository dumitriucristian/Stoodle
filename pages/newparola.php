...
<!-- style="overflow: hidden; position: absolute; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;" -->
<body>
  <div id="container">
    <form action="foldereset/newparolaphp.php" method="post">
      <div class="form-group d-flex flex-column">
      
        <a class="navbar-brand" href="../index.php" style="font-size: 2rem; font-weight: 700;">
          Stoodle
        </a>
